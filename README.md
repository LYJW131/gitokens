...
Between two commits, gitokens aggregates Claude Code token usage (per model,
...
- The transcript JSONL format is internal to Claude Code and may change
  between versions.
- Claude Code only for now; Codex / Gemini CLI logs are a planned addition.
